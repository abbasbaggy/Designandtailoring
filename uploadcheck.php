            ...
            <table class="table table-striped table-hover">
                ...
                while($row = mysqli_fetch_array($result)) { ?>
                    <tr>
                        ...
                        <td><form action="" method="get"></form>
                            <a class="btn btn-danger" href="?delete_id=<?php echo $row['filname']; ?>" title="click for delete" onclick="return confirm('sure to delete ?')"</td>
                    </tr>
                <?php } ?>
                </tbody>
            </table>
